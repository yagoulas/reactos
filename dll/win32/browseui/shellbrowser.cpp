...
class CShellBrowser :
    ...
    public MyIConnectionPointImpl<T, &DIID_DWebBrowserEvents2>,
    public MyIConnectionPointImpl<T, &DIID_DWebBrowserEvents>
{
private:
    class barInfo
    {
    ...
    HRESULT BrowseToPath(IShellFolder *newShellFolder,
    ...
    static BOOL CALLBACK AddFolderOptionsPage(HPROPSHEETPAGE thePage, LPARAM lParam)
    {
    ...
    {
        CShellBrowser                           *pThis = reinterpret_cast<T *>(hWnd);
    ...
    {
        DISPPARAMS                          params;
        CComDynamicUnkArray                 &vec = IConnectionPointImpl<T, &DIID_DWebBrowserEvents2>::m_vec;
        CComDynamicUnkArray                 &vec2 = IConnectionPointImpl<T, &DIID_DWebBrowserEvents>::m_vec;
        HRESULT                             hResult;
    ...
    HRESULT STDMETHODCALLTYPE GetBorderDW(IUnknown *punkObj, LPRECT prcBorder)
    {
    ...
    HRESULT STDMETHODCALLTYPE RequestBorderSpaceDW(IUnknown* punkObj, LPCBORDERWIDTHS pbw)
    {
        return S_OK;
    }

    HRESULT STDMETHODCALLTYPE SetBorderSpaceDW(IUnknown* punkObj, LPCBORDERWIDTHS pbw)
    {
        for (INT x = 0; x < 3; x++)
        {
    ...
    HRESULT STDMETHODCALLTYPE InsertMenusSB(HMENU hmenuShared, LPOLEMENUGROUPWIDTHS lpMenuWidths)
    {
    ...
    HRESULT STDMETHODCALLTYPE SetMenuSB(HMENU hmenuShared, HOLEMENU holemenuRes, HWND hwndActiveObject)
    {
    ...
    HRESULT STDMETHODCALLTYPE RemoveMenusSB(HMENU hmenuShared)
    {
    ...
    HRESULT STDMETHODCALLTYPE SetStatusTextSB(LPCOLESTR pszStatusText)
    {
        //
        if (pszStatusText)
        {
    ...
    HRESULT STDMETHODCALLTYPE EnableModelessSB(BOOL fEnable)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE TranslateAcceleratorSB(MSG *pmsg, WORD wID)
    {
    ...
    HRESULT STDMETHODCALLTYPE BrowseObject(LPCITEMIDLIST pidl, UINT wFlags)
    {
    ...
    HRESULT STDMETHODCALLTYPE GetViewStateStream(DWORD grfMode, IStream **ppStrm)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE GetControlWindow(UINT id, HWND *lphwnd)
    {
        if (lphwnd == NULL)
            return E_POINTER;
        *lphwnd = NULL;
    ...
    HRESULT STDMETHODCALLTYPE QueryActiveShellView(IShellView **ppshv)
    {
        if (ppshv == NULL)
            return E_POINTER;
    ...
    HRESULT STDMETHODCALLTYPE OnViewWindowActive(IShellView *ppshv)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE SetToolbarItems(LPTBBUTTON lpButtons, UINT nButtons, UINT uFlags)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE GetPropertyBag(long flags, REFIID riid, void **ppvObject)
    {
        if (ppvObject == NULL)
            return E_POINTER;
        *ppvObject = NULL;
    ...
    HRESULT STDMETHODCALLTYPE GetParentSite(IOleInPlaceSite **ppipsite)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE SetTitle(IShellView *psv, LPCWSTR pszName)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE GetTitle(IShellView *psv, LPWSTR pszName, DWORD cchName)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE GetOleObject(IOleObject **ppobjv)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE GetTravelLog(ITravelLog **pptl)
    {
        HRESULT                                 hResult;
    ...
    HRESULT STDMETHODCALLTYPE ShowControlWindow(UINT id, BOOL fShow)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE IsControlWindowShown(UINT id, BOOL *pfShown)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE IEGetDisplayName(LPCITEMIDLIST pidl, LPWSTR pwszName, UINT uFlags)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE IEParseDisplayName(UINT uiCP, LPCWSTR pwszPath, LPITEMIDLIST *ppidlOut)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE DisplayParseError(HRESULT hres, LPCWSTR pwszPath)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE NavigateToPidl(LPCITEMIDLIST pidl, DWORD grfHLNF)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE SetNavigateState(BNSTATE bnstate)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE GetNavigateState(BNSTATE *pbnstate)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE NotifyRedirect(IShellView *psv, LPCITEMIDLIST pidl, BOOL *pfDidBrowse)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE SetFlags(DWORD dwFlags, DWORD dwFlagMask)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE GetFlags(DWORD *pdwFlags)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE GetPidl(LPITEMIDLIST *ppidl)
    {
    ...
    HRESULT STDMETHODCALLTYPE SetReferrer(LPCITEMIDLIST pidl)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE GetBrowserByIndex(DWORD dwID, IUnknown **ppunk)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE GetHistoryObject(IOleObject **ppole, IStream **pstm, IBindCtx **ppbc)
    {
    ...
    HRESULT STDMETHODCALLTYPE SetHistoryObject(IOleObject *pole, BOOL fIsLocalAnchor)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE CacheOLEServer(IOleObject *pole)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE GetSetCodePage(VARIANT *pvarIn, VARIANT *pvarOut)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE GetPalette(HPALETTE *hpal)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE RegisterWindow(BOOL fForceRegister, int swc)
    {
        return E_NOTIMPL;
    }

    LRESULT STDMETHODCALLTYPE WndProcBS(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE GetViewRect(RECT *prc)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE OnSize(WPARAM wParam)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE OnCreate(struct tagCREATESTRUCTW *pcs)
    {
        return S_OK;
    }

    LRESULT STDMETHODCALLTYPE OnCommand(WPARAM wParam, LPARAM lParam)
    {
        return 0;
    }
    ...
    LRESULT STDMETHODCALLTYPE OnNotify(struct tagNMHDR *pnm)
    {
        return 0;
    }
    ...
    HRESULT STDMETHODCALLTYPE OnFrameWindowActivateBS(BOOL fActive)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE CreateBrowserPropSheetExt(REFIID riid, void **ppv)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE GetViewWindow(HWND *phwndView)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE GetBaseBrowserData(LPCBASEBROWSERDATA *pbbd)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE InitializeTravelLog(ITravelLog *ptl, DWORD dw)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE Offline(int iCmd)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE AllowViewResize(BOOL f)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE SetActivateState(UINT u)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE UpdateSecureLockIcon(int eSecureLock)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE _Initialize(HWND hwnd, IUnknown *pauto)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE _PauseOrResumeView(BOOL fPaused)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE _NavigateToPidl(LPCITEMIDLIST pidl, DWORD grfHLNF, DWORD dwFlags)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE _TryShell2Rename(IShellView *psv, LPCITEMIDLIST pidlNew)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE _ExecChildren(IUnknown *punkBar, BOOL fBroadcast,
    ...
    HRESULT STDMETHODCALLTYPE GetFolderSetData(struct tagFolderSetData *pfsd)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE _OnFocusChange(UINT itb)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE v_ShowHideChildWindows(BOOL fChildOnly)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE _put_itbLastFocus(UINT itbLastFocus)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE _UIActivateView(UINT uState)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE _GetViewBorderRect(RECT *prc)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE _ResizeNextBorder(UINT itb)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE _GetEffectiveClientArea(LPRECT lprectBorder, HMONITOR hmon)
    {
        return E_NOTIMPL;
    }

    IStream *STDMETHODCALLTYPE v_GetViewStream(LPCITEMIDLIST pidl, DWORD grfMode, LPCWSTR pwszName)
    {
        return NULL;
    }

    LRESULT STDMETHODCALLTYPE ForwardViewMsg(UINT uMsg, WPARAM wParam, LPARAM lParam)
    {
        return 0;
    }

    HRESULT STDMETHODCALLTYPE SetAcceleratorMenu(HACCEL hacc)
    {
        return E_NOTIMPL;
    }
    ...
    LPTOOLBARITEM STDMETHODCALLTYPE _GetToolbarItem(int itb)
    {
        return NULL;
    }

    HRESULT STDMETHODCALLTYPE _SaveToolbars(IStream *pstm)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE _LoadToolbars(IStream *pstm)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE _CloseAndReleaseToolbars(BOOL fClose)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE _ResizeNextBorderHelper(UINT itb, BOOL bUseHmonitor)
    {
        return E_NOTIMPL;
    }

    UINT STDMETHODCALLTYPE _FindTBar(IUnknown *punkSrc)
    {
        return 0;
    }

    HRESULT STDMETHODCALLTYPE _SetFocus(LPTOOLBARITEM ptbi, HWND hwnd, LPMSG lpMsg)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE _GetBorderDWHelper(IUnknown *punkSrc, LPRECT lprectBorder, BOOL bUseHmonitor)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE v_CheckZoneCrossing(LPCITEMIDLIST pidl)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE Navigate(BSTR URL, VARIANT *Flags,
    ...
    HRESULT STDMETHODCALLTYPE Navigate2(VARIANT *URL, VARIANT *Flags,
        VARIANT *TargetFrameName, VARIANT *PostData, VARIANT *Headers)
    {
    ...
    HRESULT STDMETHODCALLTYPE ExecWB(OLECMDID cmdID, OLECMDEXECOPT cmdexecopt,
    ...
    HRESULT STDMETHODCALLTYPE FindWindowByIndex(DWORD dwID, IUnknown **ppunk)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE GetWindowData(IStream *pStream, LPWINDOWDATA pWinData)
    {
        if (pWinData == NULL)
            return E_POINTER;
    ...
    HRESULT STDMETHODCALLTYPE LoadHistoryPosition(LPWSTR pszUrlLocation, DWORD dwPosition)
    {
        return E_NOTIMPL;
    }
    ...
    HRESULT STDMETHODCALLTYPE LoadHistory(IStream *pStream, IBindCtx *pbc)
    {
    ...
    HRESULT STDMETHODCALLTYPE SaveHistory(IStream *pStream)
    {
        CComPtr<IPersistHistory>                viewPersistHistory;
    ...
    HRESULT STDMETHODCALLTYPE SetPositionCookie(DWORD dwPositioncookie)
    {
        return E_NOTIMPL;
    }

    HRESULT STDMETHODCALLTYPE GetPositionCookie(DWORD *pdwPositioncookie)
    {
        return E_NOTIMPL;
    }
...
class CShellBrowser2 :
    public CShellBrowser<CShellBrowser2, CWindow, CFrameWinTraits>
{
public:
...
{
    return ShellObjectCreatorInit<CShellBrowser2>(riid, ppv);
}
